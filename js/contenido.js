...
window.PROYECTOS = {
  closet: { t: "Clóset industrial", linea: "Línea de mobiliario para el hogar y organización",
    d: "Clóset residencial a partir de una imagen de referencia del cliente y requerimientos de medidas, capacidad y distribución. Pino recuperado y estructura metálica, con lenguaje industrial y buena resistencia.",
    r: "Dos módulos verticales independientes e intercambiables, con espacio para colgar, almacenar y organizar.",
    rol: "Interpretar la necesidad, modelar en 3D, elaborar la documentación técnica y coordinar al proveedor de la estructura metálica.",
  ...
  cava: { t: "Cava para restaurante", linea: "Línea de mobiliario comercial (B2B)",
    d: "Cava para organizar bebidas, copas y accesorios, en pino recuperado, con esquinas redondeadas y superficies revestidas con listones.",
    r: "Compartimentos para botellas, copas y vasos en una sola estructura; la puerta suma almacenamiento sin cambiar las medidas.",
    rol: "Planos técnicos, despiece con cantidades y materiales, relación de costos para la cotización y acompañamiento en el taller.",
  ...
  biblio: { t: "Biblioteca empotrada", linea: "Línea de accesorios y objetos",
    d: "Biblioteca empotrada residencial, a partir de dos referencias del cliente, pensada para aprovechar el espacio e integrarse al ambiente.",
    r: "Superficies de almacenamiento y exhibición integradas a la arquitectura; el mueble fabricado coincide con la propuesta.",
    rol: "Bocetos, modelado 3D para validar proporciones y distribución, y plano técnico para el taller.",
  ...
  tipi: { t: "Tipi para gato", linea: "Línea para mascotas",
    d: "Refugio y espacio de descanso para gato. Desde la referencia del cliente se definieron geometría, medidas, piezas y ensamble para garantizar estabilidad.",
    r: "Un tipi funcional y estable que conserva la geometría planteada y se integra al hogar.",
    rol: "Análisis formal y constructivo, definición de medidas y ensamble, y planos de fabricación.",
...
window.PASOS = [
  { n: 1, ico: "🎯", sabias: "La madera guarda carbono: mientras un mueble de madera recuperada siga en uso, ese carbono permanece almacenado en lugar de volver a la atmósfera.", t: "¿Por qué esta pasantía?", s: "Motivación", datos: [["Pasantía", "modalidad de grado"], ["Taller real", "materiales y procesos"], ["Mirada crítica", "rol del pasante"]], layout: "orbita",
    ...
    frase: "Se asumía un reto interesante y estaba constantemente esa curiosidad por entrar directamente al mundo «real» de la producción.",
    b: ["Unir lo aprendido en la universidad con diseño y producción reales.", "Un taller donde el diseño toca materiales, procesos y tiempos de fabricación.", "EcoDeco: madera recuperada, sostenibilidad y economía circular.", "Mirar con ojo crítico el rol y las condiciones del pasante."] },

  { n: 2, ico: "🏭", sabias: "Una estiba recorre varios viajes cargada de mercancía antes de retirarse. Convertirla en mueble le da una tercera vida y evita que termine quemada o en un relleno sanitario.", t: "EcoDeco Diseño Sostenible", s: "La empresa", datos: [["Cali", "taller y fábrica"], ["Pino de estibas", "materia prima"], ["4", "líneas de producto"], ["A medida", "cada pieza es única"]], layout: "mapa", mapa: "https://www.google.com/maps?q=EcoDeco+Dise%C3%B1o+Sostenible,+Cali,+Valle+del+Cauca,+Colombia&z=13&output=embed", galeria: [["mesa-noche.jpg", "Hogar y organización"], ["comedor.jpg", "Comercial (B2B)"], ["porta-matera.jpg", "Accesorios y objetos"], ["camita.jpg", "Mascotas"]],
  ...
  { n: 5, ico: "📅", sabias: "Un pino tarda cerca de 20 años en alcanzar tamaño comercial. Una estiba puede reutilizarse varias veces antes de convertirse en mueble.", t: "Cronograma", s: "Cuatro fases", layout: "linea-tiempo", img: "biblio-boceto.jpg", pie: "Boceto de la biblioteca empotrada · Autor",
  ...
  { n: 6, ico: "🔄", sabias: "La madera que termina en un relleno sanitario se descompone sin oxígeno y libera metano, un gas de efecto invernadero mucho más potente que el CO₂.", t: "Metodología", s: "Flujo de trabajo de EcoDeco", layout: "imagen-protagonista", img: "flujo-ecodeco.jpg", pie: "Flujo de trabajo de EcoDeco Diseño Sostenible · Autor",
    ...
    flujo: {
      etapa1: { t: "1. Atención al cliente", ico: "👥", cajas: [["1.1 Recepción del encargo", "Se recibe la solicitud del cliente por los diferentes canales."], ["1.2 Levantamiento de información", "Se identifican necesidades, uso, dimensiones, estilo, presupuesto y plazo."]], decision: "¿El producto es de catálogo o personalizable?" },
      catalogo: { t: "Ruta catálogo", d: "Proceso más directo y estandarizado.", cajas: [["C.1 Selección de producto", "El cliente elige un producto del catálogo existente."], ["C.2 Confirmación de especificaciones", "Se confirman medidas, acabados, cantidad, fecha de entrega y pago."]] },
      personal: { t: "Ruta personalizable", d: "Proceso ampliado que incluye diseño, validación y posibles tercerizaciones.", cajas: [["P.1 Diseño de propuesta inicial", "Se desarrolla una propuesta de diseño según los requerimientos del cliente."], ["P.2 Presentación y validación", "Se presenta la propuesta al cliente y se realizan los ajustes necesarios."], ["P.3 Diseño técnico", "Se elabora el diseño técnico y los planos detallados para producción."], ["P.4 Integración de estructuras metálicas (opcional)", "Si se requiere, se trabaja con proveedores tercerizados para estructuras metálicas."]] },
      etapa2: { t: "2. Selección de materia prima", ico: "🪵", cajas: [["2.1 Selección de madera recuperada", "Se selecciona madera recuperada de acuerdo con el producto y la disponibilidad."], ["2.2 Clasificación y preparación", "La madera se revisa, clasifica, limpia y acondiciona para su uso."]] },
      etapa3: { t: "3. Fabricación del producto", ico: "🪚", cajas: [["3.1 Producción", "Se fabrican las piezas según el diseño aprobado y los procesos definidos."], ["3.2 Acabados y control de calidad", "Se realizan acabados, revisión de calidad y ajustes finales."], ["3.3 Entrega del producto", "Se coordina y realiza la entrega final del mobiliario al cliente."]] },
      leyenda: [["🔄", "Flujo continuo", "El proceso es dinámico y adaptable: las etapas pueden repetirse o ajustarse según el proyecto."], ["🌱", "Enfoque sostenible", "En todas las etapas se promueve el uso responsable de materiales recuperados y prácticas de producción sostenible."]]
    },
  ...
  { n: 7, ico: "📚", sabias: "Diseñar para el desmontaje, con piezas que se separan sin romperse, facilita reparar el mueble y reciclar sus partes al final de su vida.", t: "Marco teórico", s: "Cuatro autores", layout: "autores",
  ...
  { n: 8, ico: "🪑", sabias: "Cada estiba recuperada aporta entre 15 y 25 kilos de madera de pino lista para una segunda vida.", t: "Cuatro proyectos", s: "Un caso por línea de producto", layout: "proyectos",
  ...
  { n: 9, ico: "💡", sabias: "Fabricar con material recuperado exige más diseño, no menos: cada pieza se adapta a las medidas y a los defectos de la madera disponible.", t: "Hallazgos", s: "El aporte del diseño", datos: [["~30", "proyectos"], ["4", "líneas"], ["3D + planos", "herramientas clave"]], layout: "imagen-alta-izq", img: "cava-final.jpg", pie: "Cava para restaurante · producto final · Autor",
  ...
  { n: 10, ico: "⚖️", tHtml: "Lo que <mark>preocupa</mark>", sabias: "Un mueble que dura décadas también es una decisión ambiental: alargar la vida útil de los objetos es una de las formas más efectivas de reducir residuos.", t: "Lo que preocupa", s: "Pasantía y dignidad laboral", layout: "manifiesto", img: "biblio-final.jpg", pie: "Biblioteca empotrada · producto final · Autor",
    lead: "La experiencia dejó ver una situación recurrente en pequeñas y medianas empresas: la dificultad para diferenciar el <mark>carácter formativo</mark> de la pasantía de las <mark>necesidades operativas</mark> de la organización.",
