...
window.PASOS = [
  ...
  { n: 3, ico: "❓", sabias: "Según la FAO, el planeta pierde alrededor de 10 millones de hectáreas de bosque cada año. Reutilizar madera reduce la presión sobre los bosques.", t: "Problemática", s: "Formación y operación", layout: "banner", img: "comedor.jpg", pie: "Comedor · producción de EcoDeco · @ecodeco_co",
  ...
  { n: 10, ico: "⚖️", sabias: "Un mueble que dura décadas también es una decisión ambiental: alargar la vida útil de los objetos es una de las formas más efectivas de reducir residuos.", t: "Lo que preocupa", s: "Pasantía y dignidad laboral", layout: "manifiesto", img: "biblio-final.jpg", pie: "Biblioteca empotrada · producto final · Autor",
